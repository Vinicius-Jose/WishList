...
public class ServicoEmail {
	...
	public void servicoEmail(Usuario user) {
		...
		try {
			...
			sp.setMsg("Olá" + user.getPrimeiroNome() + "" + user.getSegundoNome()
					...
					+ "Esta mensagem é gerada automaticamente, assim como a nova senha, sua senha é segura e de responsabilidade de nossos usuários");// Mensagem
